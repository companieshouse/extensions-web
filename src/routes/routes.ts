...
import {render as showDueDateLimitExceededPage} from "../controllers/extension.limit.reached.controller";
...
router.get(pageURLs.EXTENSION_LIMIT_REACHED, showDueDateLimitExceededPage);
